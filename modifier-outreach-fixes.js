...
function ensureSpawnModifiersInState(){const spawnIds=new Set(SPAWN_MODIFIER_SEED.map(modifier=>modifier.id));state.modifiers.forEach(modifier=>{modifier.working=modifier.working!==false;if(spawnIds.has(modifier.id))modifier.isSpawn=true;if(modifier.isSpawn&&!modifier.grade)modifier.grade='B'});SPAWN_MODIFIER_SEED.forEach(seed=>{if(!state.modifiers.some(modifier=>modifier.id===seed.id))state.modifiers.push({...seed,isSpawn:true,grade:'B',zone:'',trigger:'Spawn',working:true,iconData:'',superEnabled:false,superName:'',superGrade:'',superDescription:'',updatedAt:new Date().toISOString()})})}
...
state.modifiers.forEach(modifier=>{
  ...
  modifier.working=modifier.working!==false;
});
...
modifierKeywordStyles.textContent='.modifier-keyword{font-weight:800;text-shadow:none}.modifier-keyword-power{color:#ff353d}.modifier-keyword-health{color:#35d66f}.modifier-keyword-speed{color:#fff}.modifier-keyword-range{color:#ffd83d}.mod-card{align-items:start;min-height:142px;padding:14px}.mod-card p{display:block;-webkit-line-clamp:unset;-webkit-box-orient:initial;overflow:visible;line-height:1.55}.mod-card .grade-icon,.mod-card .spawn-db-label{align-self:start}.modifier-card-state{display:flex;flex-direction:column;align-items:center;gap:9px}.modifier-working-badge{min-width:70px;padding:5px 7px;border:1px solid #236b42;background:#10251a;color:#67e59a;text-align:center;font:800 7px inherit;letter-spacing:.08em}.modifier-working-badge.not-working{border-color:#8c2e36;background:#2a1115;color:#ff6973}.mod-card .modifier-working-note{margin-top:10px;padding:8px 9px;border-left:2px solid #d84954;background:#251418;color:#ff9ca3;font-size:8px;line-height:1.45}.modifier-working-control{display:grid;gap:13px;padding:15px 16px;border:1px solid #245c3a;background:linear-gradient(135deg,#102218,#121516)}.modifier-working-row{display:flex;align-items:center;justify-content:space-between;gap:18px}.modifier-working-control h3{margin:0;color:#67e59a;font:800 9px inherit;letter-spacing:.14em}.modifier-working-control p{margin:5px 0 0;color:#727a74;font-size:9px}.modifier-working-control.not-working{border-color:#713038;background:linear-gradient(135deg,#281317,#151315)}.modifier-working-control.not-working h3{color:#ff6973}.modifier-working-control textarea{resize:vertical}.modifier-working-toggle{display:flex;align-items:center;gap:9px;cursor:pointer}.modifier-working-toggle input{position:absolute;opacity:0;pointer-events:none}.modifier-working-toggle span{width:22px;height:22px;border:1px solid #4b755a;background:#12281b;display:grid;place-items:center}.modifier-working-toggle input:checked+span:after{content:\'✓\';color:#70eca2;font-size:15px}.modifier-working-toggle strong{min-width:88px;color:#70eca2;font-size:9px;letter-spacing:.1em}.modifier-working-control.not-working .modifier-working-toggle span{border-color:#88404a;background:#2d151a}.modifier-working-control.not-working .modifier-working-toggle strong{color:#ff6973}';
